...
function AdminDashboard() {
  ...
  const { allPayments, finalMonths } = useSelector((state) => state.razorpay);
  ...
  return (
    <HomeLayout>
      <div
        className="min-h-[90vh] pt-5 flex flex-col flex-wrap gap-10
            pb-24
            text-black"
      >
              ...
              {myCourses?.map((course, idx) => {
                return (
                  <tr key={course._id}>
                    ...
                    <td className="max-w-28 overflow-hidden text-ellipsis blackspace-nowrap">
                      <textarea
