...
return (
    ...
    <div className="min-h-[90vh] flex items-center justify-center text-black">
        ...
        <h1 className="bg-green-500 absolute top-0 w-full py-4 text-2xl text-white font-bold text-center">Payment Successfully</h1>
        ...
        <AiFillCheckCircle className="text-green-500 text-5xl"></AiFillCheckCircle>
            ...
            <Link to="/" className="bg-green-500 hover:bg-green-600 transition-all ease-in-out duration-300 absolute bottom-0 py-2 text-xl font-semibold text-center rounded-b-lg text-white w-full">
