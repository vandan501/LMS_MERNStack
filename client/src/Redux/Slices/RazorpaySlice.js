...
import axiosInstance from "../../Helpers/axiosInstance"; // Check the import statement for correctness
...
export const purchaseCourseBundle = createAsyncThunk("/purchaseCourse", async () => {
    try {
        ...
        console.log("purchaseCourseBundle response:", response); // Add this line
        return response.data;
    } catch (error) {
